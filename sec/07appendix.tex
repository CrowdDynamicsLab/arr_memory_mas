...
\end{cases}
\]
\hs{[STYLE] Number this equation --- use \texttt{\textbackslash begin\{equation\}} rather than \texttt{\textbackslash[...\textbackslash]}. Numbered equations are required for cross-referencing.}
...
\hs{[STYLE] Ambiguous pronoun: add a noun after ``This'' to clarify what you are referring to. E.g., ``This contrast is the empirical content\ldots'' or ``This finding is the empirical content\ldots''}
