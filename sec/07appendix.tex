...
The unified written instructions actually issued to annotators --- including the four-level rubric with worked examples, the E3 binary final-leakage criterion with worked examples, decision rules, input/output format, blinding procedure, and operational details --- are released verbatim alongside the code as \texttt{annotation\_guide.md} in the supplementary materials. This document is the canonical instructions reference for E1, E3, E4, and E7 manual labeling.
