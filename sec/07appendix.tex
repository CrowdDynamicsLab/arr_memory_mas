...
{Qwen3-32B} was run only on the hard-budget E2 conditions and is therefore reported in the main compression table rather than the full trajectory tables.
...
\paragraph{Fisher exact tests.} Table~\ref{tab:app_fisher} reports two-sided Fisher exact $p$-values for the primary {GPT-5-mini} and DeepSeek-R1-32B contrasts.
